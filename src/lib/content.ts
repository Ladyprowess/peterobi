...
export const sectors: Sector[] = [
  {
    ...
    record: {
      ...
      points: [
        "He met a state with no accredited health institution and left twelve, two of them hospitals.",
        "He built the Anambra State University Teaching Hospital and fitted it with modern laboratories, consulting clinics and vaccine cold storage.",
        ...
        "He wiped out polio and kept Anambra free of it for five straight years.",
        "He won the state a ₦120 million immunisation award for that record.",
...

  {
    ...
    record: {
      headline: "What he did in Anambra",
      points: [
        "He met Anambra ranked 26th of 36 states in WAEC and left it first in the country.",
        "He kept it first for his last three years in office.",
        "He sent school money straight to the schools instead of through the ministry, and the results moved.",
...

  {
    ...
    record: {
      ...
      points: [
        ...
        "He owed nothing, no debt, no contractor, no supplier, no salary and no pension.",
        "He held the money in standard bonds and accounts at known public rates.",
        "He left the handover notes open for anyone to verify.",
        "He refused a ₦500 million presidential lodge and stayed in a hotel instead.",
        "He started sovereign wealth savings, the first Nigerian state ever to do it.",
        "He mapped the state from the air to decide where roads and clinics should go.",
        "He brought SABMiller and Innoson Motors in to build their plants.",
      ],
    },
    plan: {
      headline: "What he will do as president",
...

  {
    ...
    record: {
      ...
      points: [
        ...
        "He made every contractor sign a maintenance bond.",
        "He held them to repairing their own roads for five to seven years after building them.",
...

  {
    ...
    record: {
      headline: "What he did in Anambra",
      points: [
        "He fought his November 2006 impeachment in court and won his seat back in February 2007.",
        "He was the first Anambra governor ever to take his mandate back that way.",
        "He won the case that fixed how a governor's four year term is counted, and changed the rule for governors across the country.",
...

  {
    ...
    record: {
      ...
      points: [
        ...
        "He brought in Innoson Motors, a Nigerian vehicle manufacturer.",
        "He paid the state's bills and kept debt low, which is why they came.",
      ],
    },
    plan: {
      headline: "What he will do as president",
...

  {
    ...
    record: {
      ...
      points: [
        ...
        "He took children off the street and into care.",
        "He funded stroke and trauma rehabilitation, which almost no state pays for.",
