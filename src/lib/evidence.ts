...
export const evidence: EvidenceItem[] = [
  ...
  { id: "obi-savings-account", sector: "Economy", claim: "Obi says he left $150 million and \u20a636 billion in state savings when he finished his term as Governor of Anambra State in 2014.", context: "His account, as he has put it publicly. On debt, he states he left none and owed no contractors, suppliers or workers for unpaid salaries or pensions. On where the money sat, he explains the funds were placed in standard bonds and accounts at known public rates. On verification, he insists the handover notes are open for anyone to check, and he rejects claims of personal gain. Reported by The Punch.", status: "record", sourceIds: ["obiSavingsDefence"] },
